...
d. If the user wants to reproduce the results of the second example of Convection-diffusion equation (See Subsection 5.2, the inviscid Burgers equation), he/she can simply change specific things in Script "Convection_Diffusion_Ex1.m".
